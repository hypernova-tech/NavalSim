...
public:
	...
	static FVector FindRPYFromVectors(const FVector& Vec, const FVector& Dir);
	...
	static bool CheckBoxInsideVolume(bool is_local, const FBox& box, const FVector& origin, const FVector &dir, FLOAT64 min_elevation_deg, FLOAT64 max_elevation_deg, FLOAT64 min_azimuth_deg, FLOAT64 max_azimuth_deg, FLOAT64 min_range_meter, FLOAT64 max_range_meter, FVector& local_rpy);
	...
	static INT32U EncodeUnsigned32(FLOAT64 val, FLOAT64 lsb);

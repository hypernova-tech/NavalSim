...
function getInfo(fileName) {
    ...
    return 'Heightmap name: ' + fileName + '\n' +
        ...
        'Zoom: ' + grid.zoom + '\n' +
		'TopLeftLat: ' + bounds.topleft[1] + '\n' +
		'TopLeftLon: ' + bounds.topleft[0] + '\n'+
		'BottomRightLat ' + bounds.bottomright[1] + '\n'+
		'BottomRightLon: ' + bounds.bottomright[0] + '\n';
		printt(hmaplast);
		printt(lastHeightMap);
}
